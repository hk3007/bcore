            ...
            <div className="bcore-video-section">
                ...
                <div className="bcore-video-container">
                    ...
                    <div className="bcore-video-content-card">
                        ...
                        <div className="bcore-president-info">
                            <h3 className="bcore-president-name">
                                Smt. Droupadi Murmu
                            </h3>

                            <p className="bcore-president-designation">
                        ...
                        <div className="bcore-video-author">
                            <strong>— Smt. Droupadi Murmu</strong>
                            <span>Hon'ble President of India</span>
                        </div>
